...
class PurchaseReceipt(Base):
    ...
    is_one_time_substitute = Column(Boolean, nullable=False, default=False)
    received_item_name = Column(String(100), nullable=True)
    unit_cost = Column(Integer, nullable=True)
    replacement_unit_price = Column(Integer, nullable=True)
    quantity = Column(Integer, nullable=False)
    actor = Column(String(50), nullable=True)
    note = Column(Text, nullable=True)
